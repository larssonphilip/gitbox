...
// Without this class, if you try to scroll over the textview (which fits its scrollview), you won't scroll any view at all.
@interface GBNonScrollingScrollView : NSScrollView
@end
